...
const Discover = ({ navigation }) => {
  ...
  return (
    ...
    >
      <View>
        <Image
          source={require("../assets/cartoongirl.png")}
      ...
      <View style={{ margin: 9 }}>
        ...
        >
          ...
          <Text style={{ color: "#FFD720" }}>the Vedas</Text>
        </Text>

        <Text style={{ color: "white", margin: 18 }}>
          Sign up and{" "}
          <Text style={{ color: "#FFD720" }}>
            {" "}
        ...
        >
          ...
          <TouchableOpacity onPress={() => navigation.navigate("emptyscreen")}>
            <Image
        ...
        <View
          style={{ marginTop: "3%", display: "flex", flexDirection: "column" }}
        >
          <TouchableOpacity
            style={{
