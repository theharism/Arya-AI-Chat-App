...
const Signup = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, alignItems: 'center', width, marginTop: '10%', marginTop: 37, width, height, margin: height > 800 ? '2%' : '0%' }}>
            <View style={{ marginTop: '5%', alignSelf: 'center', justifyContent: 'center', alignContent: 'center', margin: height > 800 ? '5%' : '-15%' }}>
                <Image source={require('../assets/Mokx.png')} style={{ width: height > 800 ? 172 : 110, height: height > 800 ? 172 : 160, }} />
            </View>
            ...
            {/* Next */}
            <View style={{ marginTop: '0%', display: 'flex', flexDirection: 'column', width }}>
